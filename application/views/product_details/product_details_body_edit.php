                                            ...
                                            <div id="myNicPanel" >
                                                <div class="view-product" id="frontcard" style="position:relative">
                                                    ...
                                                    <img class="drag" id="logo" src="http://bakerstreetbabes.com/wp-content/uploads/2013/07/intel-company-logo-png-hd-sk.png"
                                                         ...
                                                         ?>
                                                            <div class="drag"  style="cursor: move;position: absolute;font-family: <?php echo $card->font_family ?>;font-size: <?php echo $card->font_size ?>; color: <?php echo $card->color ?>;left: <?php echo $card->left_pos ?>;top: <?php echo $card->top_pos ?>;"> abc<?php echo $card->text; ?></div>
