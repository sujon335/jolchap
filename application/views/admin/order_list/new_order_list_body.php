                        ...
                        if (isset($new_orders)):
                            ...
                            foreach ($new_orders as $order):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/admin_order/move_order_to_process/<?php echo $order['order_id']; ?>">Process Order</a>
                                        <hr>
                                        <a class="btn btn-danger"  href="<?php echo base_url(); ?>index.php/admin_order/move_order_to_trash/<?php echo $order['order_id']; ?>"> Move to Trash</a>
                                    </td>
                                </tr> 
                                <?php
                            endforeach;
