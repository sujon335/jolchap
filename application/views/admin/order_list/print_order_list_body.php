        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Order in Printing Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        if (isset($new_orders)):
                            ...
                            foreach ($new_orders as $order):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/admin_order/move_order_to_shipping/<?php echo $order['order_id']; ?>">Send to Shipping</a>
