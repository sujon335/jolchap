      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2016 <a href="http://jolchapbd.com">JolchapBD</a>.</strong> All rights reserved.
      </footer>
    ...
    <!-- Sparkline -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    ...
    <!-- ChartJS 1.0.1 -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/plugins/chartjs/Chart.min.js"></script>
