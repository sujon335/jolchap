        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Featured Products Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">

                    <form role="form" enctype="multipart/form-data" method="post" 
                          action="<?php echo base_url(); ?>index.php/admin/add_featured_product">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        if (isset($products)):
                            ...
                            foreach ($products as $product):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>index.php/admin/remove_featured_product/<?php echo $product['product_id']; ?>"
