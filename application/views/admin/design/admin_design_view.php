                                            ...
                                            <div class="brands_products"><!--brands_products-->
                                                ...
                                                <div class="brands-name">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            <input  type="text"
                                                                    class="abc form-control" id="<?php echo $i; ?>"
                                                                    placeholder="Enter Text Here" <?php if($i>=5) echo  'style=" display: none"'; ?>>
                                                        </div>
                                                        <?php endfor; ?>
                                            ...
                                            <div class="brands_products"><!--brands_products-->
                                                ...
                                                <div class="brands-name">
                                                   ...
                                                   <option value="selectFont">Select Font</option>
                                                                ...
                                                                <option style="font-family:Georgia;" value="Georgia">Georgia</option>
                                                                <option style="font-family:Palatino Linotype;" value="Palatino Linotype">Palatino Linotype</option>
                                                                <option style="font-family:Times New Roman;" value="Times New Roman">Times New Roman</option>         </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <input  type="text"
                                                                    class="abc form-control" id="<?php echo $i; ?>_back"
                                                                    placeholder="Enter Text Here" <?php if($i>=5) echo  'style=" display: none"'; ?>>
                                                        </div>
                                                        <?php endfor; ?>

                                                        <div class="form-group">
                                                            <button  class="form-control" id="add-another_back">Add another</button>
                                                        </div>
                ...
                <div class="product-image-wrapper"><!--product-details-->
                    ...
                    <div class="single-products" style=" padding: 10px;"><!--/product-information-->
                        ...
                        <p><b>Unit Price:</b> 800 tk</p>
                            ...
                            <a id="save_btn_user" class="btn btn-block btn-success" href="#">Save Design</a>
                            ...
                            <script>
                                ...
                                $(document).ready(function(){
                                    ...
                                    $("#add-another").click(function(e){
                                        /*
                                        var xx ='<div class="form-group"><input type="text" class="abc form-control" onkeyup="set_div_text('+cnt+')" id="';
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    $("#save_btn_user").click(function(event) {
                                        ...
                                        jQuery.ajax({
                                            type: "POST",
                                            url: "<?php echo base_url(); ?>" + "index.php/admin_design/save_design_user",
